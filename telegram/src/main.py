...
async def main():
    ...
    try:
        ...
        dp.include_router(shopping_cart_router)
        ...
        shopping_cart_router.callback_query.middleware(
            session_fabric_middleware
        )
        shopping_cart_router.callback_query.middleware(confid_middleware)
